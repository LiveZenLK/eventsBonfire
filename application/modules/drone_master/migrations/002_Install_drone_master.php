...
class Migration_Install_drone_master extends Migration
{
	/**
	 ...
	 * @var String
	 */
	private $table_name = 'drone_master';
	...
	private $fields = array(
		...
		'propellor_protection_val' => array(
			'type' => 'VARCHAR',
			'constraint' => 200,
			'null' => FALSE,
		),
		'screwdriver_set' => array(
			'type' => 'VARCHAR',
			'constraint' => 10,
			'null' => FALSE,
		),
		'screwdriver_set_val' => array(
			'type' => 'VARCHAR',
			'constraint' => 200,
			'null' => FALSE,
		),
		'single_screwdriver' => array(
			'type' => 'VARCHAR',
			'constraint' => 10,
			'null' => FALSE,
		),
		'single_screwdriver_val' => array(
			'type' => 'VARCHAR',
			'constraint' => 200,
			'null' => FALSE,
		),
