...
class Migration_Install_drone_master_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Drone_Master.Setmasters.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Drone_Master.Setmasters.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Drone_Master.Setmasters.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Drone_Master.Setmasters.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
