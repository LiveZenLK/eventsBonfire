...
class Migration_Install_issue_mobile_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Issue_Mobile.Issueset.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Issue_Mobile.Issueset.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Issue_Mobile.Issueset.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Issue_Mobile.Issueset.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
