...
class Migration_Install_add_customer_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Add_Customer.Maangecustomers.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Add_Customer.Maangecustomers.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Add_Customer.Maangecustomers.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Add_Customer.Maangecustomers.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
