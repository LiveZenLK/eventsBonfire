	...
	<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
		<fieldset>
			...
			<div class="form-actions">
				<input type="submit" name="save" class="btn btn-primary" value="<?php echo lang('add_customer_action_edit'); ?>"  />
				<?php echo lang('bf_or'); ?>
				<?php echo anchor(SITE_AREA .'/maangecustomers/add_customer', lang('add_customer_cancel'), 'class="btn btn-warning"'); ?>
				
			<?php if ($this->auth->has_permission('Add_Customer.Maangecustomers.Delete')) : ?>
				or
				<button type="submit" name="delete" class="btn btn-danger" id="delete-me" onclick="return confirm('<?php e(js_escape(lang('add_customer_delete_confirm'))); ?>'); ">
					<span class="icon-trash icon-white"></span>&nbsp;<?php echo lang('add_customer_delete_record'); ?>
				</button>
			<?php endif; ?>
			</div>
		</fieldset>
