...
<div class="admin-box">
   ...
   <br /><br />
	 ...
	 <p><?php echo anchor(SITE_AREA . '/issueset/issue_umts_mobile/returnsets/' , '<input type="button" value="View Return Sets" class="btn btn-warning">') ?></p>
