...
class Migration_Install_issue_umts_mobile_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Issue_UMTS_Mobile.Issueset.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Issue_UMTS_Mobile.Issueset.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Issue_UMTS_Mobile.Issueset.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Issue_UMTS_Mobile.Issueset.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
