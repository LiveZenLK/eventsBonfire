...
class Migration_Install_fp_set_master_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'FP_Set_Master.Setmasters.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'FP_Set_Master.Setmasters.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'FP_Set_Master.Setmasters.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'FP_Set_Master.Setmasters.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
