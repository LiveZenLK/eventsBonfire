			...
			<table>
                            ...
                            <tr style="height: 50px;">
                                <td class="column-check" style="width: 520px;text-align: left">
                                    <input type="checkbox" name="fp_set_master_panasonic_HCV700" id="fp_set_master_panasonic_HCV700" value='1' <?php echo (isset($fp_set_master['panasonic_HCV700']) && $fp_set_master['panasonic_HCV700'] == 1) ? 'checked="checked"' : set_checkbox('fp_set_master_panasonic_HCV700', 1); ?>/><label style="display: inline" for="fp_set_master_panasonic_HCV700">Panasonic HC-V700</label>
                                ...
                                <td class="column-check" style="width: 450px;;text-align: left">
                                    <input name="fp_set_master_microphone_rode" type="checkbox" id="fp_set_master_microphone_rode" value='1' <?php echo (isset($fp_set_master['microphone_rode']) && $fp_set_master['microphone_rode'] == 1) ? 'checked="checked"' : set_checkbox('fp_set_master_microphone_rode', 1); ?>/><label style="display: inline" for="fp_set_master_microphone_rode">Microphone Rode</label>
                                </td>
                                <td class="column-check" style="width: 450px;;text-align: left">
                                    <input type="checkbox" name="fp_set_master_macbook13" id="fp_set_master_macbook13" value='1' <?php echo (isset($fp_set_master['macbook13']) && $fp_set_master['macbook13'] == 1) ? 'checked="checked"' : set_checkbox('fp_set_master_macbook13', 1); ?>/><label style="display: inline" for="fp_set_master_macbook13">MacBook 13</label>
                            ...
                            <tr style="height: 50px;">
                                <td class="column-check" style="width: 520px;text-align: left">
                                    <input type="checkbox" name="fp_set_master_panasonic_HCV727" id="fp_set_master_panasonic_HCV727" value='1' <?php echo (isset($fp_set_master['panasonic_HCV727']) && $fp_set_master['panasonic_HCV727'] == 1) ? 'checked="checked"' : set_checkbox('fp_set_master_panasonic_HCV727', 1); ?>/><label style="display: inline" for="fp_set_master_panasonic_HCV727">Panasonic HC-V727</label>
                                ...
                                <td class="column-check" style="width: 450px;text-align: left">
                                    <input name="fp_set_master_extension_cable" type="checkbox" id="fp_set_master_extension_cable" value='1' <?php echo (isset($fp_set_master['extension_cable']) && $fp_set_master['extension_cable'] == 1) ? 'checked="checked"' : set_checkbox('fp_set_master_extension_cable', 1); ?>/><label style="display: inline" for="fp_set_master_extension_cable">Extension Cable</label>
                                </td>
                                <td class="column-check" style="width: 450px;text-align: left">
                                    <input type="checkbox" name="fp_set_master_macbook15" id="fp_set_master_macbook15" value='1' <?php echo (isset($fp_set_master['macbook15']) && $fp_set_master['macbook15'] == 1) ? 'checked="checked"' : set_checkbox('fp_set_master_macbook15', 1); ?>/><label style="display: inline" for="fp_set_master_macbook15">MacBook 15</label>
                                </td>
                            </tr>
                            ...
                            <tr style="height: 50px;">
                                ...
                                <td class="column-check" style="width: 450px;text-align: left">
                                    <input type="checkbox" name="fp_set_master_recorder_sony_PMW50" id="fp_set_master_recorder_sony_PMW50" value='1' <?php echo (isset($fp_set_master['recorder_sony_PMW50']) && $fp_set_master['recorder_sony_PMW50'] == 1) ? 'checked="checked"' : set_checkbox('fp_set_master_recorder_sony_PMW50', 1); ?>/><label style="display: inline" for="fp_set_master_recorder_sony_PMW50">Recorder Sony PMW 50</label>
                                </td>
                            </tr>
                            ...
                            <tr style="height: 50px;">
                                ...
                                <td class="column-check" style="width: 450px;text-align: left">
                                    <input type="checkbox" name="fp_set_master_aja_interface" id="fp_set_master_aja_interface" value='1' <?php echo (isset($fp_set_master['aja_interface']) && $fp_set_master['aja_interface'] == 1) ? 'checked="checked"' : set_checkbox('fp_set_master_aja_interface', 1); ?>/> <label style="display: inline" for="fp_set_master_aja_interface">AJA Interface</label>
                                </td>
                            ...
                            <tr style="height: 50px;">
                                ...
                                <td class="column-check" style="width: 450px;text-align: left">
                                    <input type="checkbox" name="fp_set_master_sxs_card_reader" id="fp_set_master_sxs_card_reader" value='1' <?php echo (isset($fp_set_master['sxs_card_reader']) && $fp_set_master['sxs_card_reader'] == 1) ? 'checked="checked"' : set_checkbox('fp_set_master_sxs_card_reader', 1); ?>/> <label style="display: inline" for="fp_set_master_sxs_card_reader">SxS Card Reader</label>
                                </td>
                            ...
                            <tr style="height: 50px;">
                                ...
                                <td class="column-check" style="width: 450px;text-align: left">
                                    <input type="checkbox" name="fp_set_master_liveu" id="fp_set_master_liveu" value='1' <?php echo (isset($fp_set_master['liveu']) && $fp_set_master['liveu'] == 1) ? 'checked="checked"' : set_checkbox('fp_set_master_liveu', 1); ?>/><label style="display: inline" for="fp_set_master_liveu">LiveU</label>
                                </td>
                                <td class="column-check" style="width: 450px;text-align: left">
                                    <input type="checkbox" name="fp_set_master_thunderbold_SSD_cable" id="fp_set_master_thunderbold_SSD_cable" value='1' <?php echo (isset($fp_set_master['thunderbold_SSD_cable']) && $fp_set_master['thunderbold_SSD_cable'] == 1) ? 'checked="checked"' : set_checkbox('fp_set_master_thunderbold_SSD_cable', 1); ?>/><label style="display: inline" for="fp_set_master_thunderbold_SSD_cable"> Thunderbold SSD + Cable </label>
                                </td>
                            ...
                            <tr style="height: 50px;">
                                <td class="column-check" style="width: 520px;text-align: left">
                                 <input type="checkbox" name="fp_set_master_SD_card_amount" id="fp_set_master_SD_card_amount" value='1' <?php echo (isset($fp_set_master['SD_card_amount']) && $fp_set_master['SD_card_amount'] == 1) ? 'checked="checked"' : set_checkbox('fp_set_master_SD_card_amount', 1); ?>/><label style="display: inline" for="fp_set_master_SD_card_amount">SD Card</label>
                                ...
                                <td class="column-check" style="width: 450px;text-align: left">
                                    <input name="fp_set_master_minicaster" type="checkbox" id="fp_set_master_minicaster" value='1' <?php echo (isset($fp_set_master['minicaster']) && $fp_set_master['minicaster'] == 1) ? 'checked="checked"' : set_checkbox('fp_set_master_minicaster', 1); ?>/><label style="display: inline" for="fp_set_master_minicaster">Minicaster</label>
                                </td>
                                <td class="column-check" style="width: 450px;text-align: left">
                                    <input type="checkbox" name="fp_set_master_mac_charger" id="fp_set_master_mac_charger" value='1' <?php echo (isset($fp_set_master['mac_charger']) && $fp_set_master['mac_charger'] == 1) ? 'checked="checked"' : set_checkbox('fp_set_master_mac_charger', 1); ?> /><label style="display: inline" for="fp_set_master_mac_charger">Mac Charger</label>
                                </td>
                             ...
                             <tr style="height: 50px;">
                                <td class="column-check" style="width: 520px;text-align: left">
                                 <input type="checkbox" name="fp_set_master_mini_sd_card" id="fp_set_master_mini_sd_card" value='1' <?php echo (isset($fp_set_master['mini_sd_card']) && $fp_set_master['mini_sd_card'] == 1) ? 'checked="checked"' : set_checkbox('fp_set_master_mini_sd_card', 1); ?>/><label style="display: inline" for="fp_set_master_mini_sd_card">Mini-SD Card</label>
                                 <span style="float: right;margin-right: 30px;"><b>Amount:</b>
                                ...
                                <td class="column-check" style="width: 450px;text-align: left">
                                    <input name="fp_set_master_newsspotter" type="checkbox" id="fp_set_master_newsspotter" value='1' <?php echo (isset($fp_set_master['newsspotter']) && $fp_set_master['newsspotter'] == 1) ? 'checked="checked"' : set_checkbox('fp_set_master_newsspotter', 1); ?>/><label style="display: inline" for="fp_set_master_newsspotter">Newsspotter</label>
                                </td>
                                <td class="column-check" style="width: 450px;text-align: left">
                             ...
                             <tr style="height: 50px;">
                                <td class="column-check" style="width: 520px;text-align: left">
                                <input type="checkbox" name="fp_set_master_sd_card_adaptor" id="fp_set_master_sd_card_adaptor" value='1' <?php echo (isset($fp_set_master['sd_card_adaptor']) && $fp_set_master['sd_card_adaptor'] == 1) ? 'checked="checked"' : set_checkbox('fp_set_master_sd_card_adaptor', 1); ?>/><label style="display: inline" for="fp_set_master_sd_card_adaptor">SD Card Adaptor</label>
                                 
                                </td>
                                <td class="column-check" style="width: 450px;text-align: left">
                                    <input name="fp_set_master_BGAN_explorer" type="checkbox" id="fp_set_master_BGAN_explorer" value='1' <?php echo (isset($fp_set_master['BGAN_explorer']) && $fp_set_master['BGAN_explorer'] == 1) ? 'checked="checked"' : set_checkbox('fp_set_master_BGAN_explorer', 1); ?>/><label style="display: inline" for="fp_set_master_BGAN_explorer"> BGAN Explorer</label>
                                </td>
                                <td class="column-check" style="width: 450px;text-align: left">
                            ...
                            <tr style="height: 50px;">
                                <td class="column-check" style="width: 520px;text-align: left">
                                 <input type="checkbox" name="fp_set_master_battery_700_small" id="fp_set_master_battery_700_small" value='1' <?php echo (isset($fp_set_master['battery_700_small']) && $fp_set_master['battery_700_small'] == 1) ? 'checked="checked"' : set_checkbox('fp_set_master_battery_700_small', 1); ?>/> <label style="display: inline" for="fp_set_master_battery_700_small">Battery 700 small</label>
                                 <span style="float: right;margin-right: 30px;"><b>Amount:</b>
                                ...
                                <td class="column-check" style="width: 450px;text-align: left">
                                    <input name="fp_set_master_cullmann_magnesit" type="checkbox" id="fp_set_master_cullmann_magnesit" value='1' <?php echo (isset($fp_set_master['cullmann_magnesit']) && $fp_set_master['cullmann_magnesit'] == 1) ? 'checked="checked"' : set_checkbox('fp_set_master_cullmann_magnesit', 1); ?>/><label style="display: inline" for="fp_set_master_cullmann_magnesit">Cullmann Magnesit</label>
                                </td>
                                <td class="column-check" style="width: 450px;text-align: left">
                                    <input type="checkbox" name="fp_set_master_walkie_talkie" id="fp_set_master_walkie_talkie" value='1' <?php echo (isset($fp_set_master['walkie_talkie']) && $fp_set_master['walkie_talkie'] == 1) ? 'checked="checked"' : set_checkbox('fp_set_master_walkie_talkie', 1); ?>/><label style="display: inline" for="fp_set_master_walkie_talkie">Walkie Talkie UV-5R+</label>
                                </td>
                            ...
                            <tr style="height: 50px;">
                                <td class="column-check" style="width: 520px;text-align: left">
                                 <input type="checkbox" name="fp_set_master_battery_700_big" id="fp_set_master_battery_700_big" value='1' <?php echo (isset($fp_set_master['battery_700_big']) && $fp_set_master['battery_700_big'] == 1) ? 'checked="checked"' : set_checkbox('fp_set_master_battery_700_big', 1); ?>/><label style="display: inline" for="fp_set_master_battery_700_big">Battery 700 big</label>
                                 <span style="float: right;margin-right: 30px;"><b>Amount:</b>
                                ...
                                <td class="column-check" style="width: 450px;text-align: left">
                                    <input name="fp_set_master_cullmann_nanomax" type="checkbox" id="fp_set_master_cullmann_nanomax" value='1' <?php echo (isset($fp_set_master['cullmann_nanomax']) && $fp_set_master['cullmann_nanomax'] == 1) ? 'checked="checked"' : set_checkbox('fp_set_master_cullmann_nanomax', 1); ?>/><label style="display: inline" for="fp_set_master_cullmann_nanomax">Cullmann Nanomax</label>
                                </td>
                                <td class="column-check" style="width: 450px;text-align: left">
                                    <input type="checkbox" name="fp_set_master_first_aid_kit" id="fp_set_master_first_aid_kit" value='1' <?php echo (isset($fp_set_master['first_aid_kit']) && $fp_set_master['first_aid_kit'] == 1) ? 'checked="checked"' : set_checkbox('fp_set_master_first_aid_kit', 1); ?>/><label style="display: inline" for="fp_set_master_first_aid_kit">First Aid Kit</label>
                                </td>
                            ...
                            <tr style="height: 50px;">
                                <td class="column-check" style="width: 520px;text-align: left">
                                 <input type="checkbox" name="fp_set_master_battery_727VWVBT190" id="fp_set_master_battery_727VWVBT190" value='1' <?php echo (isset($fp_set_master['battery_727VWVBT190']) && $fp_set_master['battery_727VWVBT190'] == 1) ? 'checked="checked"' : set_checkbox('fp_set_master_battery_727VWVBT190', 1); ?>/><label style="display: inline" for="fp_set_master_battery_727VWVBT190">Battery 727 VW-VBT190</label>
                                ...
                                <td class="column-check" style="width: 450px;text-align: left">
                                    <input name="fp_set_master_tripods_checkbox1" type="checkbox" id="fp_set_master_tripods_checkbox1" value='1' <?php echo (isset($fp_set_master['tripods_checkbox1']) && $fp_set_master['tripods_checkbox1'] == 1) ? 'checked="checked"' : set_checkbox('fp_set_master_tripods_checkbox1', 1); ?>/><label style="display: inline" for="fp_set_master_tripods_checkbox1">Tripode Plate</label>
                                </td>
                                <td class="column-check" style="width: 450px;text-align: left">
                                    <input type="checkbox" name="fp_set_master_backpack" id="fp_set_master_backpack" value='1' <?php echo (isset($fp_set_master['backpack']) && $fp_set_master['backpack'] == 1) ? 'checked="checked"' : set_checkbox('fp_set_master_backpack', 1); ?>/> <label style="display: inline" for="fp_set_master_backpack">Backpack</label>
                                </td>
                            ...
                            <tr style="height: 50px;">
                                <td class="column-check" style="width: 520px;text-align: left">
                                 <input type="checkbox" name="fp_set_master_battery_727VWVBT380" id="fp_set_master_battery_727VWVBT380" value='1' <?php echo (isset($fp_set_master['battery_727VWVBT380']) && $fp_set_master['battery_727VWVBT380'] == 1) ? 'checked="checked"' : set_checkbox('fp_set_master_battery_727VWVBT380', 1); ?>/><label style="display: inline" for="fp_set_master_battery_727VWVBT380">Battery 727 VW-VBT380</label>
                            ...
                            <tr style="height: 50px;">
                                <td class="column-check" style="width: 520px;text-align: left">
                                 <input type="checkbox" name="fp_set_master_battery_handycam" id="fp_set_master_battery_handycam" value='1' <?php echo (isset($fp_set_master['battery_handycam']) && $fp_set_master['battery_handycam'] == 1) ? 'checked="checked"' : set_checkbox('fp_set_master_battery_handycam', 1); ?>/><label style="display: inline" for="fp_set_master_battery_handycam">Battery Handycam</label>
                                 <span style="float: right;margin-right: 30px;"><b>Amount:</b>
                             ...
                             <tr style="height: 50px;">
                                <td class="column-check" style="width: 520px;text-align: left">
                                 <input type="checkbox" name="fp_set_master_charger_patona" id="fp_set_master_charger_patona" value='1' <?php echo (isset($fp_set_master['charger_patona']) && $fp_set_master['charger_patona'] == 1) ? 'checked="checked"' : set_checkbox('fp_set_master_charger_patona', 1); ?>/><label style="display: inline" for="fp_set_master_charger_patona">Charger Patona</label>
                                </td>
                                <td class="column-check" style="width: 450px;text-align: left">
                            ...
                            <tr style="height: 50px;">
                                <td class="column-check" style="width: 520px;text-align: left">
                                 <input type="checkbox" name="fp_set_master_Battery_small_panasonic" id="fp_set_master_Battery_small_panasonic" value='1' <?php echo (isset($fp_set_master['Battery_small_panasonic']) && $fp_set_master['Battery_small_panasonic'] == 1) ? 'checked="checked"' : set_checkbox('fp_set_master_Battery_small_panasonic', 1); ?>/><label style="display: inline" for="fp_set_master_Battery_small_panasonic">2 Battery Small Panasonic VW-VBK-180</label>
                                ...
                                <td class="column-check" style="width: 450px;text-align: left">
                                    <input name="fp_set_master_one_cam_charger_panasonic" type="checkbox" id="fp_set_master_one_cam_charger_panasonic" value='1' <?php echo (isset($fp_set_master['one_cam_charger_panasonic']) && $fp_set_master['one_cam_charger_panasonic'] == 1) ? 'checked="checked"' : set_checkbox('fp_set_master_one_cam_charger_panasonic', 1); ?>/><label style="display: inline" for="fp_set_master_one_cam_charger_panasonic">1 Cam-Charger Panasonic VSK0781</label>
