...
<div class="admin-box">
	...
	<br /><?php echo form_open($this->uri->uri_string(),array('class'=>'form-wrapper cf', 'id'=>'search_form')); ?>
				<div>
					<input type="hidden" name="search" value="">
					<select name="searchType" class="customselect">
					    <option value="">Select Search Type</option>
					    <option value="imeino" <?php echo isset($_POST['searchType'])&& $_POST['searchType']=="imeino"?" selected='selected'":""?>>Search By IMEI No</option>
					</select>
				</div>
