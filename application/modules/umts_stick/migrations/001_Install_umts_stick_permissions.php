...
class Migration_Install_umts_stick_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'UMTS_Stick.Managemobile.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'UMTS_Stick.Managemobile.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'UMTS_Stick.Managemobile.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'UMTS_Stick.Managemobile.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
