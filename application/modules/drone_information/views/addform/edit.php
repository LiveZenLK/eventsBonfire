...
$settype = $drone_information['drone_set_type'];
$id = isset($drone_information['id']) ? $drone_information['id'] : '';
?>
<div class="admin-box">
	...
	<?php echo form_open($this -> uri -> uri_string(), 'class="form-horizontal"'); ?>
		<fieldset>
                        ...
                        <div class="control-group" style="height: 60px;">
                             ...
                             <div class="control-group <?php echo form_error('drone_information_drone_customer') ? 'error' : ''; ?>" style="float: left; width: 350px;">
                        ...
                        <div class="control-group" style="height: 68px;">
                            ...
                            <div  style="float: left; width: 350px;" > 
                      		 ...
                      		 <div style="float: left;" class="control-group">
                                <?php echo form_label('Received By'. lang('bf_form_label_required'), 'drone_information_receivedBy', array('class' => 'control-label') ); ?>	
                                <div class='controls'>
                                    <select id="drone_information_receivedBy" name="drone_information_receivedBy">
                                        <option value="">--Received By--</option>
                                        <?php
                                        foreach ($mcrs as $mcr):
                                        if($mcr->id==$receivedBy){ ?>
                                           <option selected="selected" value="<?php echo $mcr->id;?>"><?php echo $mcr->username;?></option>
                                           <?php }
			                                   else { ?>
	                                   <option value="<?php echo $mcr->id;?>"><?php echo $mcr->username;?></option>
	...
	`					 <div class="control-group" style=" margin-left: 120px; margin-top: 10px;">
                            ...
                            <input type="text" id="drone_information_job"  name="drone_information_job" maxlength="200" value="<?php echo set_value('drone_information_job', isset($drone_information['job']) ? $drone_information['job'] : ''); ?>"/>
                         </div>	
	                            ...
	                            <div class='controls' aria-labelled-by='drone_information_drone_set_type_label'>
	                                <select name="drone_information_drone_set_type" id="drone_information_drone_set_type" onchange="loadDrone(this.value);" style="width:220px;">
	                                	...
	                                	<?php foreach ($droneset as $drone) : 
	                                		 if($drone->id==$settype){ ?>
	                                    <option selected="selected" value="<?php echo $drone->id;?>" ><?php echo $drone->setType;?></option>
										 <?php } else { ?>
	                                   		<option value="<?php echo $drone->id;?>"><?php echo $drone->setType;?></option>
										<?php } endforeach;  ?>	
	                                </select>					
                         ...
                         <table class="customTable">
                             ...
                             <tr>
                                ...
                                <td class="column-check">
                                 ...
                                 <td  class="column-check">     
                                    <input id='drone_information_screwdriver_set_val' type='text' name='drone_information_screwdriver_set_val' maxlength="200" value="<?php echo set_value('drone_information_screwdriver_set_val', isset($drone_information['screwdriver_set_val']) ? $drone_information['screwdriver_set_val'] : ''); ?>" />
                                 </td>
                             </tr>   
                              ...
                              <tr>
                                ...
                                <td class="column-check">
                                 ...
                                 <td  class="column-check">     
                                    <input id='drone_information_remote_control_val' type='text' name='drone_information_remote_control_val' maxlength="200" value="<?php echo set_value('drone_information_remote_control_val', isset($drone_information['remote_control_val']) ? $drone_information['remote_control_val'] : ''); ?>" />
                                 </td>
                             </tr>   
                              ...
                              <tr>
                                ...
                                <td class="column-check">
                                 ...
                                 <td  class="column-check">     
                                    <input id='drone_information_antennas_fpv_monitor_val' type='text' name='drone_information_antennas_fpv_monitor_val' maxlength="200" value="<?php echo set_value('drone_information_antennas_fpv_monitor_val', isset($drone_information['antennas_fpv_monitor_val']) ? $drone_information['antennas_fpv_monitor_val'] : ''); ?>" />
                                 </td>
                             </tr>   
                             ...
                             <tr>
                                ...
                                <td class="column-check">
                                 ...
                                 <td  class="column-check">     
                                    <input id='drone_information_charger_fpv_monitor_val' type='text' name='drone_information_charger_fpv_monitor_val' maxlength="200" value="<?php echo set_value('drone_information_charger_fpv_monitor_val', isset($drone_information['charger_fpv_monitor_val']) ? $drone_information['charger_fpv_monitor_val'] : ''); ?>" />
                                 </td>
                             </tr>
                              ...
                              <tr>
                                ...
                                <td class="column-check">
                                 ...
                                 <td  class="column-check">     
                                    <input id='drone_information_console_fpv_monitor_val' type='text' name='drone_information_console_fpv_monitor_val' maxlength="200" value="<?php echo set_value('drone_information_console_fpv_monitor_val', isset($drone_information['console_fpv_monitor_val']) ? $drone_information['console_fpv_monitor_val'] : ''); ?>" />
                                 </td>
                             </tr>
                             ...
                             <tr>
                                ...
                                <td class="column-check">
                                 ...
                                 <td  class="column-check">     
                                    <input id='drone_information_hardcase_val' type='text' name='drone_information_hardcase_val' maxlength="200" value="<?php echo set_value('drone_information_hardcase_val', isset($drone_information['hardcase_val']) ? $drone_information['hardcase_val'] : ''); ?>" />
                                 </td>
                             </tr>
