...
class Migration_Install_drone_information_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Drone_Information.Addform.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Drone_Information.Addform.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Drone_Information.Addform.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Drone_Information.Addform.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
