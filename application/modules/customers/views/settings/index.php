...
$num_columns	= 3;
$can_delete	= $this->auth->has_permission('Customers.Settings.Delete');
$can_edit		= $this->auth->has_permission('Customers.Settings.Edit');
		...
		<table class="table table-bordered">
			...
			<tbody>
				...
				<tr>
					...
					<?php if ($can_edit) : ?>
						<td>
							<a href="<?php echo site_url('admin/settings/customers/edit/')."/".$record->id;?>"</a>
