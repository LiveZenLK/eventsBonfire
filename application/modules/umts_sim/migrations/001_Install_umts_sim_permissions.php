...
class Migration_Install_umts_sim_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'UMTS_SIM.Managesim.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'UMTS_SIM.Managesim.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'UMTS_SIM.Managesim.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'UMTS_SIM.Managesim.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
