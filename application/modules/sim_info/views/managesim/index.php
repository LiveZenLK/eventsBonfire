...
$num_columns	= 8;
$can_delete	= $this->auth->has_permission('SIM_Info.Managesim.Delete');
$can_edit		= $this->auth->has_permission('SIM_Info.Managesim.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class="table table-bordered">
			...
			<tfoot>
				...
				<tr>
					<td colspan="<?php echo $num_columns; ?>">
						...
						<input type="submit" name="delete" id="delete-me" class="btn btn-danger" value="<?php echo lang('bf_action_delete'); ?>" onclick="return confirm('<?php e(js_escape(lang('sim_info_delete_confirm'))); ?>')" />
					</td>
				</tr>
				<?php endif; ?>
			</tfoot>
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/managesim/sim_info/edit/' . $record->id, '<span class="icon-pencil"></span>' .  $record->simCardName); ?></td>
				<?php else : ?>
