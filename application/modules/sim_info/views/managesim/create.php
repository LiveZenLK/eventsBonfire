	...
	<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
		<fieldset>
			...
			<div class="control-group <?php echo form_error('comment') ? 'error' : ''; ?>">
				...
				<div class='controls'>
					<?php echo form_textarea( array( 'name' => 'sim_info_comment', 'id' => 'sim_info_comment', 'rows' => '5', 'cols' => '80', 'value' => set_value('sim_info_comment', isset($sim_info['comment']) ? $sim_info['comment'] : '') ) ); ?>
					<span class='help-inline'><?php echo form_error('comment'); ?></span>
				</div>
			</div>

			<div class="form-actions">
				<input type="submit" name="save" class="btn btn-primary" value="<?php echo lang('sim_info_action_create'); ?>"  />
				<?php echo lang('bf_or'); ?>
