...
class Migration_Install_sim_info_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'SIM_Info.Managesim.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'SIM_Info.Managesim.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'SIM_Info.Managesim.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'SIM_Info.Managesim.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
