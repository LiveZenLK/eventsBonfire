...
class Migration_Install_mobile_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Mobile.Managemobile.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Mobile.Managemobile.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Mobile.Managemobile.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Mobile.Managemobile.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
