...
class Migration_Install_mcr_information_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'MCR_Information.Addform.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'MCR_Information.Addform.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'MCR_Information.Addform.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'MCR_Information.Addform.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
