...
?>
<div class="admin-box">
	<h3>MCR Information<span style="color: red"> (Return Sets) </span></h3>
   ...
   <br /><br />
        ...
        <p><?php echo anchor(SITE_AREA . '/addform/mcr_information/index/' , '<input type="button" value="View Issued Sets" class="btn btn-warning">') ?></p>
