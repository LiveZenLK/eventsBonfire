...
<div class="admin-box">
		...
		<fieldset>
                ...
                <div class="control-group" style="height: 50px;">
                        ...
                        <?php echo form_label('Customer Name'. lang('bf_form_label_required'), 'mcr_information_parentCustomer', array('class' => 'control-label') ); ?>	
                            <div class='controls'>
                                <select id="mcr_information_parentCustomer" name="mcr_information_parentCustomer">
                                    ...
                                    ?>
                                   <option value="<?php echo $user->id;?>" <?php echo set_value('mcr_information_parentCustomer')==$user->id?'selected':''; ?>><?php echo $user->name;?></option>
                                   <?php endforeach;?>
                                </select>	
                            </div>
                        </div>
                    ...
                    <div style="float: left">
                        ...
                        <?php echo form_label('Issued By'. lang('bf_form_label_required'), 'mcr_information_parentMcr', array('class' => 'control-label') ); ?>	
                            <div class='controls'>
                                <select id="mcr_information_parentMcr" name="mcr_information_parentMcr">
                                    ...
                                    foreach ($mcrs as $mcr):
                                    ?>
                                   <option value="<?php echo $mcr->id;?>" <?php echo set_value('mcr_information_parentMcr')==$mcr->id?'selected':''; ?>><?php echo $mcr->username;?></option>
                                   <?php endforeach;?>
                                </select>	
                            </div>
                        </div>
                ...
                <div class="control-group" style="height: 50px;">
	                <div style="float: left;margin-top: 20px" <?php echo form_error('issueDate') ? 'error' : ''; ?>>
		                <?php echo form_label('Issue Date'. lang('bf_form_label_required'), 'mcr_information_issueDate', array('class' => 'control-label') ); ?>
		                <div class='controls'>
            ...
            <div class="control-group">
                    ...
                    <?php echo form_label('Received By'. lang('bf_form_label_required'), 'mcr_information_receivedBy', array('class' => 'control-label') ); ?>	
                        <div class='controls'>
                            <select id="mcr_information_receivedBy" name="mcr_information_receivedBy">
                                ...
                                foreach ($mcrs as $mcr):
                                ?>
                               <option value="<?php echo $mcr->id;?>" <?php echo set_value('mcr_information_receivedBy')==$mcr->id?'selected':''; ?>><?php echo $mcr->username;?></option>
                               <?php endforeach;?>
                            </select>	
                        </div>
                    </div>
                ...
                <div  style="margin-top: 20px;margin-left: 10px;" <?php echo form_error('returnDate') ? 'error' : ''; ?>>
			...
			<div class="form-actions">
				<input type="submit" name="save" class="btn btn-primary" value="<?php echo lang('mcr_information_action_create'); ?>"  />
				<?php echo lang('bf_or'); ?>
    ...
    <script>
     function loadFpSet(value) 
		 {
			$.ajax({
		      type: "get",
              async: false,
              url: "<?php echo site_url('/admin/setmasters/fp_set_master/loadFpSet')?>",
              data: {fpsetId: value},
              dataType: "json",
			   ...
			   success: function(data) 
			   {
                if(data!='')
                {
                	 ...
                	 {
                	 	var elem = document.getElementById('mcr_information_' + key);
                	 	if(elem)
                	 	{
